...
| single_T8 | 6.16e-04 | 5.32e-05 | 2.15e-02 | PASS (tight) |
| single_T64 | 7.04e-04 | 5.84e-05 | 3.02e-02 | PASS (tight) |
| single_T65 | 7.07e-04 | 5.83e-05 | 2.71e-02 | PASS (tight) |
| single_T128 | 7.07e-04 | 5.88e-05 | 3.41e-02 | PASS (tight) |
| single_T256 | 8.36e-04 | 5.83e-05 | 3.32e-02 | PASS (tight) |
| single_T1024 | 9.50e-04 | 5.87e-05 | 3.17e-02 | PASS (tight) |
| varlen_balanced_4x32 | 9.57e-04 | 6.56e-05 | 3.20e-02 | PASS (tight) |
| varlen_unbalanced | 9.48e-04 | 6.52e-05 | 2.97e-02 | PASS (tight) |
| varlen_single_T128 | 7.07e-04 | 5.88e-05 | 3.41e-02 | PASS (tight) |
| single_T128_initstate | 7.81e-04 | 6.00e-05 | 3.22e-02 | PASS (tight) |
| varlen_initstate | 1.29e-03 | 7.99e-05 | 4.15e-02 | PASS (tight) |
...
| single_T8 | 5.33e-03 | 4.03e-04 | 3.09e-02 | PASS (loose) |
| single_T64 | 6.85e-03 | 4.88e-04 | 4.16e-02 | PASS (loose) |
| single_T65 | 6.88e-03 | 4.88e-04 | 3.45e-02 | PASS (loose) |
| single_T128 | 8.79e-03 | 4.83e-04 | 4.51e-02 | PASS (loose) |
| single_T256 | 9.89e-03 | 4.86e-04 | 8.31e-02 | PASS (loose) |
| single_T1024 | 1.44e-02 | 4.83e-04 | 3.41e-02 | PASS (loose) |
| varlen_balanced_4x32 | 1.16e-02 | 5.28e-04 | 3.12e-02 | PASS (loose) |
| varlen_unbalanced | 1.16e-02 | 5.27e-04 | 3.25e-02 | PASS (loose) |
| varlen_single_T128 | 8.79e-03 | 4.83e-04 | 3.18e-02 | PASS (loose) |
| single_T128_initstate | 1.03e-02 | 5.05e-04 | 5.38e-02 | PASS (loose) |
| varlen_initstate | 1.33e-02 | 6.91e-04 | 3.62e-02 | PASS (loose) |
...
| single_T8 | 6.93e-03 | 7.97e-04 | 2.12e-02 | PASS (loose) |
| single_T64 | 8.76e-03 | 8.72e-04 | 8.42e-02 | PASS (loose) |
| single_T65 | 8.77e-03 | 8.73e-04 | 2.88e-02 | PASS (loose) |
| single_T128 | 1.32e-02 | 8.57e-04 | 2.71e-02 | PASS (loose) |
| single_T256 | 1.32e-02 | 8.86e-04 | 2.76e-02 | PASS (loose) |
| single_T1024 | 1.32e-02 | 8.90e-04 | 3.76e-02 | PASS (loose) |
| varlen_balanced_4x32 | 1.91e-02 | 9.63e-04 | 3.91e-02 | PASS (loose) |
| varlen_unbalanced | 1.91e-02 | 9.70e-04 | 3.33e-02 | PASS (loose) |
| varlen_single_T128 | 1.32e-02 | 8.57e-04 | 2.71e-02 | PASS (loose) |
| single_T128_initstate | 1.32e-02 | 8.87e-04 | 4.09e-02 | PASS (loose) |
| varlen_initstate | 1.25e-02 | 1.17e-03 | 4.05e-02 | PASS (loose) |
...
| single_T8 | 8.94e-03 | 1.40e-03 | 2.82e-02 | PASS (loose) |
| single_T64 | 1.72e-02 | 1.84e-03 | 3.09e-02 | PASS (loose) |
| single_T65 | 1.73e-02 | 1.83e-03 | 3.95e-02 | PASS (loose) |
| single_T128 | 1.73e-02 | 1.86e-03 | 3.75e-02 | PASS (loose) |
| single_T256 | 2.39e-02 | 1.91e-03 | 4.88e-02 | PASS (loose) |
| single_T1024 | 2.84e-02 | 1.94e-03 | 4.78e-02 | PASS (loose) |
| varlen_balanced_4x32 | 2.23e-02 | 2.07e-03 | 4.74e-02 | PASS (loose) |
| varlen_unbalanced | 2.30e-02 | 2.07e-03 | 4.92e-02 | PASS (loose) |
| varlen_single_T128 | 1.73e-02 | 1.86e-03 | 3.42e-02 | PASS (loose) |
| single_T128_initstate | 2.41e-02 | 1.88e-03 | 3.27e-02 | PASS (loose) |
| varlen_initstate | 2.39e-02 | 2.17e-03 | 4.97e-02 | PASS (loose) |
...
|-------|-------|--------|---------|-------|-------|------|
| L0 | 30 | 28 | 2 | 28 | 0 | 141.75s |
| L6 | 30 | 28 | 2 | 0 | 28 | 142.54s |
| L13 | 30 | 28 | 2 | 0 | 28 | 142.42s |
| L22 | 30 | 28 | 2 | 0 | 28 | 142.73s |
| **Total** | **120** | **112** | **8** | **28** | **84** | **~9.5 min** |
